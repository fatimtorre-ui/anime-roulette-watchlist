...
<template>
    <section class="rounded-3xl border border-slate-700/70 bg-slate-900/60 p-5 shadow-2xl shadow-slate-950/30 backdrop-blur-sm">
        <div v-if="props.loading"
        class="space-y-4">
        <div class="flex items-center gap-3 text-cyan-300">
            <div class=" h-5 w-5 animate-spin rounded-full border-2 border-cyan-400 border-t-transparent">
            </div>
    ...
    >
      ...
      <div class="flex flex-wrap gap-3">
        ...
        <div v-else class="rounded-2xl border border-slate-700/60 bg-slate-800/50 p-6 text-center text-slate-300">Pull the lever to request your first random anime
